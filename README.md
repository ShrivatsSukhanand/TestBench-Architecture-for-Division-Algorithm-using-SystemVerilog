Enhanced the testbench architecture I used for the 8-bit comparator to verify a 16-bit signed non-restoring division algorithm. Introduced clocking blocks for synchronised signal sampling, and integrated a monitor and scoreboard for self-checking. 
